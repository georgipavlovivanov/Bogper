...
import com.example.msbogper.jooq.schemabooks.Indexes;
...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
    ...
    /**
     * The reference instance of <code>schemaBooks.schema_version</code>
     */
    ...
    /**
     * The column <code>schemaBooks.schema_version.installed_rank</code>.
     */
    ...
    /**
     * The column <code>schemaBooks.schema_version.type</code>.
     */
    ...
    /**
     * The column <code>schemaBooks.schema_version.script</code>.
     */
    ...
    /**
     * The column <code>schemaBooks.schema_version.checksum</code>.
     */
    public final TableField<SchemaVersionRecord, Integer> CHECKSUM = createField(DSL.name("checksum"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>schemaBooks.schema_version.installed_by</code>.
     */
    ...
    /**
     * The column <code>schemaBooks.schema_version.installed_on</code>.
     */
    public final TableField<SchemaVersionRecord, LocalDateTime> INSTALLED_ON = createField(DSL.name("installed_on"), SQLDataType.LOCALDATETIME(10).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP()", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>schemaBooks.schema_version.execution_time</code>.
     */
    ...
    /**
     * The column <code>schemaBooks.schema_version.success</code>.
     */
    ...
    /**
     * Create an aliased <code>schemaBooks.schema_version</code> table reference
     */
    ...
    /**
     * Create a <code>schemaBooks.schema_version</code> table reference
     */
